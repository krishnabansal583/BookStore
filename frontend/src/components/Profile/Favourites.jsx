...
//               {/* Card Container */}
//               <div className="relative bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border-2 border-pink-200 group-hover:border-pink-300">
//                 {/* Favourite Badge */}
